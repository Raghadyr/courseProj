 ...
 * @author jawaher
 */
public class Helpstaff extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Helpstaff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    rs=st.executeQuery("SELECT e.Name_,e.Emp_id,m.Med_id,m.Vis_id FROM theme_park.employee as e inner join theme_park.helps as h inner join theme_park.medical_case as m   WHERE e.Emp_id=h.E_id");
