 ...
 * @author jawaher
 */
public class MrideV extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ride Maintence staff");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MrideV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    rs=st.executeQuery("SELECT Name_,Emp_id,Ride_name FROM theme_park.employee,theme_park.ride WHERE Emp_id=E_id");
