 ...
 * @author jawaher
 */
public class Orgstaff extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Orgnizers staff");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Orgstaff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    rs=st.executeQuery("SELECT Name_,Emp_id,Event_No,Theme FROM theme_park.employee,theme_park.event_ WHERE Emp_id=E_id");
