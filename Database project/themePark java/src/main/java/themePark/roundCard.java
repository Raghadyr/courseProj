 ...
 * @author jawaher
 */
public class roundCard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ride control visitors");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(roundCard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    rs=st.executeQuery("SELECT r.R_num,r.Ride_name,c.Card_sn FROM theme_park.Round as r inner join theme_park.reduse_points WHERE r.Ride_name=c.Ride_name");
