 ...
 * @author jawaher
 */
public class RidecontStaff extends javax.swing.JFrame {

    /**
     * Creates new form MrideV
     */
    public RidecontStaff() {
        initComponents();
        selectEmp();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ride conrol staff");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RidecontStaff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    rs=st.executeQuery("SELECT e.Name_,e.Emp_id,ro.R_num,r.Ride_name FROM theme_park.employee as e inner join theme_park.ride as r inner join theme_park.round as ro where Emp_id=E_id");
