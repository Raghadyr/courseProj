 ...
 * @author jawaher
 */
public class eventVis extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(eventVis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    rs=st.executeQuery("SELECT v.Name_,v.Vis_id,e.Event_No FROM theme_park.visitors as v inner join theme_park.visit as e where v.Vis_id=e.Vis_id");
